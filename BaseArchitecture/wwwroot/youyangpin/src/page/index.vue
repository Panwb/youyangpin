	...
	<el-container>
	  ...
	  <el-main>
	    <div class="wd1200">
	      <div class="typebox">
	        <div class="topbox">
	           <span class="lab">全部(<i>11111</i>)</span>
	           <span class="lab">美搭(<i>1112</i>)</span>
	           <span class="lab">美妆个护(<i>11111</i>)</span>
	           <span class="lab">居家(<i>11111</i>)</span>
	           <span class="lab">美食<i>1112</i>)</span>
	           <span class="lab">母婴(<i>11111</i>)</span>
	           <span class="lab">型男(<i>91</i>)</span>
			   <span class="lab">其他(<i>91</i>)</span>
	        </div>
	        <div class="bottombox">
	            <el-row>
	         ...
	         <el-row :gutter="20">
				  <el-col :span="6" v-for="(o, index) in 6" :key="o">
				    <el-card :body-style="{ padding: '0px' }" shadow="hover">
				      ...
				      <div class="content">
				        <p class="words"><span class="icon icon-tao"></span>【天猫精选】加厚半高领中长款毛衣</p>
				        <div class="middle">
				            <span class="money">￥<i class="count">58</i></span>
				            <div class="price">
				        ...
				        <div class="bottom clearfix">
				          <div class="moneybox
				          ">佣金：<span class="money">30.5%</span></div> <el-button class="button enterbtn">进店拿样</el-button>
				        </div>
				      </div>
				    </el-card>
				  </el-col>
	     ...
	     <div class="pagebox">
		    <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange":current-page.sync="currentPage1":page-size="100" layout="prev, pager, next, jumper" :total="1000">
            </el-pagination>
		  </div>
	    </div>
	  </el-main>
