             ...
             <el-container>
				  <el-main class="maincon">
				    ...
				    <div class="content">
				        <div class="titlelist">
				           <ul> 
				              <li class="active"><span class="circle">1</span><span class="word">1.输入手机号</span></li>
				              <li><span class="circle">2</span><span class="word">2.验证身份</span></li>
				              <li><span class="circle">3</span><span class="word">3.设置新密码</span></li>
				              <li><span class="circle">4</span><span class="word">4.完成</span></li>
				           </ul>
				        </div>
	                    <!--1.输入手机号-->
	                    <div class="modifypsd registerbox  modifypsd1">
	                         <el-form :model="ruleForm1"  :rules="rules1" ref="ruleForm1" label-width="100px">
							  ...
							  <el-form-item label="验证码" prop="yzCode">
							    <el-input  v-model="ruleForm1.yzCode"  auto-complete="off"  placeholder="请输入图形验证码"  class="codetxt"></el-input> <span class="imgbox"><img src="../../../assets/images/hamburger.png" class="logo"></span>
							  </el-form-item>
							  <el-form-item>
	                    ...
	                    <!--2.验证身份-->
	                    <div class="modifypsd registerbox modifypsd2">
	                         <el-form :model="ruleForm2"  :rules="rules2" ref="ruleForm2" label-width="100px">
	                           <el-form-item label="手机号码">
								  <span>1515793806</span>
							   </el-form-item>
							   <el-form-item label="短信验证码" prop="mobileYzCode">
							    <el-input  v-model="ruleForm2.mobileYzCode"  auto-complete="off"  placeholder="请输入6位数字短信验证码"  class="codetxt"></el-input><el-button class="getcode">获取验证码</el-button>
							   </el-form-item>
							   <el-form-item>
	                    ...
	                    <!--3.设置新密码-->
	                    <div class="modifypsd registerbox modifypsd3">
	                    ...
	                    <!--4.完成-->
	                    <div class="modifypsd registerbox modifypsd4">
	                         <div class="tip">恭喜您,密码重置成功</div>
                             <div class="link">您现在可以<a href="../login/login.html">登录</a>或返回<a href="../index/index.html">优样品首页</a></div>
	                    </div>
				    </div>
				  </el-main>
			  </el-container>
